...
#d is interate.
#look for the key that i'm looking for
def lookup(d, key):
    found = False
    for child in d:
...
#name is unique, can't insert the same name twice
#insert or ignore and then select using the logical key twice to figure out what the primary key of the aritst, whether we inserted it or just looked it up.
